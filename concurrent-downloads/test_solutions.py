...
#Aquí se presenta un error, debido a que el método test_asyncio es una función síncrona, pero dentro de ella, estás llamando a asyncio_main, que es una función asíncrona (async_def) 
